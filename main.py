...
def write_data_to_html(data, output_file):
    with open(output_file, 'w') as file:
        ...
        file.write('        const aValue = (columnIndex === 2) ? parseInt(a.children[columnIndex].textContent) : a.children[columnIndex].textContent;\n')
        file.write('        const bValue = (columnIndex === 2) ? parseInt(b.children[columnIndex].textContent) : b.children[columnIndex].textContent;\n')
        file.write('\n')
        file.write('        if (sortOrder === "asc") {\n')
        file.write('            return (columnIndex === 2) ? aValue - bValue : aValue.localeCompare(bValue);\n')
        file.write('        } else {\n')
        file.write('            return (columnIndex === 2) ? bValue - aValue : bValue.localeCompare(aValue);\n')
        file.write('        }\n')
        file.write('    });\n')
        file.write('\n')
